...
REM Recovered Collection Global Consistency Bridge V1 (18th bridge)

set "REPO_DIR=%~dp0"
set "BRANCH=backup/v1-substrate-candidate-20260412-globalconsistency"
set "TAG=backup-v1-substrate-candidate-20260412-globalconsistency"
...
if exist ".git" (
    ...
    REM Commit
    echo Committing... >> "%LOG%"
    git commit -m "Recovered Collection Global Consistency Bridge V1 — 18th bridge milestone, 2551 assertions, 28 runners, 30 modules" >> "%LOG%" 2>&1
    ...
    git tag -f "%TAG%" -m "Backup: V1 Substrate Candidate with Collection Global Consistency Bridge (18th bridge)" >> "%LOG%" 2>&1
