...
set "REPO_DIR=%~dp0"
set "BRANCH=backup/v1-substrate-candidate-20260411-seq"
set "TAG=backup-v1-substrate-candidate-20260411-seq"
...
if exist ".git" (
    ...
    REM Commit
    echo Committing... >> "%LOG%"
    git commit -m "Recovered Page Sequence Contract Bridge V1 — 12th bridge milestone, 1586 assertions, 22 runners" >> "%LOG%" 2>&1
    ...
    git tag -f "%TAG%" -m "Backup: V1 Substrate Candidate with Page Sequence Contract Bridge" >> "%LOG%" 2>&1
