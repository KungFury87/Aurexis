...
REM Rolling Shutter Temporal Transport Bridge V1 (19th bridge)

set "REPO_DIR=%~dp0"
set "BRANCH=backup/v1-substrate-candidate-20260413-rstransport"
set "TAG=backup-v1-substrate-candidate-20260413-rstransport"
...
if exist ".git" (
    ...
    REM Commit
    echo Committing... >> "%LOG%"
    git commit -m "Rolling Shutter Temporal Transport Bridge V1 — 19th bridge milestone, 2840 assertions, 29 runners, 31 modules" >> "%LOG%" 2>&1
    ...
    git tag -f "%TAG%" -m "Backup: V1 Substrate Candidate with Rolling Shutter Temporal Transport Bridge (19th bridge)" >> "%LOG%" 2>&1
