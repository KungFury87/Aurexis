...
OUT = Path('/tmp/round154_factor03'); OUT.mkdir(exist_ok=True)
...
LR_GROUP = np.array([1.0, 1.0, 1.0, 0.3, 0.3, 0.3, 0.3])
...
print(f"R154 7-DOF per-group lr (0.3x): T-lr=1.0x, R+S-lr=0.3x")
